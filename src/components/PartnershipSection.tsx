          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div ref={rightRef} className={`bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 transition-all duration-700 delay-200 ${rightVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
              ...
              <Button
                ...
                className="w-full mt-8 bg-henzai-terracota hover:bg-henzai-terracota/90 text-white font-gantari font-semibold py-4 rounded-full text-base md:text-lg transition-all duration-300 hover:scale-105"
              >
