  ...
  return (
    <section className="py-20 bg-gradient-to-br from-henzai-blue to-henzai-blue/80 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 mb-12 animate-slide-in" style={{ animationDelay: '0.2s' }}>
            {benefits.map((benefit, index) => (
              <div key={index} className="flex items-center gap-2">
                ...
                <span className="font-gantari text-lg font-medium">{benefit.text}</span>
        ...
        {/* Depoimentos */}
        <div className="mt-20 max-w-5xl mx-auto text-white">
          <h3 className="text-3xl md:text-4xl font-bold text-center mb-12">O que nossos clientes dizem</h3>
