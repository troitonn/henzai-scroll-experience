          ...
          <div className="text-white backdrop-blur-md bg-white/10 rounded-3xl p-8 border border-white/20 shadow-2xl">
            <div ref={titleRef} className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-8">
              <div>
                <h2 className={`font-libre-franklin text-4xl md:text-5xl font-bold mb-6 transition-all duration-700 ${titleVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                  Nascemos de uma frustração: <span className="text-henzai-terracota">energia mal vendida.</span>
                </h2>
                ...
                <p className={`font-gantari text-xl leading-relaxed text-henzai-off-white transition-all duration-700 delay-200 ${titleVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                  Empresários compravam painéis solares sem entender o retorno financeiro. Pagavam caro, sem planejamento, sem acompanhamento. A Henzai existe para mudar isso: aqui, cada projeto começa pelo número — quanto você gasta, quanto vai economizar e em quanto tempo recupera o investimento.
                </p>
              </div>
            ...
            <div ref={statsRef} className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <div className={`text-center transition-all duration-700 hover:scale-110 ${statsVisible ? 'opacity-100 scale-100 animate-in' : 'opacity-0 scale-75'}`}>
                  ...
                  <div className="font-gantari text-sm uppercase tracking-wider">Usinas em operação</div>
                </div>
                <div className={`text-center transition-all duration-700 delay-200 hover:scale-110 ${statsVisible ? 'opacity-100 scale-100 animate-in' : 'opacity-0 scale-75'}`}>
                  ...
                  <div className="font-gantari text-sm uppercase tracking-wider">devolvidos aos clientes em economia</div>
                </div>
              </div>
              ...
              <div ref={quoteRef} className={`bg-henzai-blue/20 backdrop-blur-sm rounded-3xl p-8 mb-8 border border-white/10 transition-all duration-700 ${quoteVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <p className="font-gantari text-lg italic leading-relaxed mb-6">
                  "Nosso trabalho não termina quando o sistema liga. Termina quando o cliente vê o dinheiro voltando para o caixa — e decide investir em crescimento."
                </p>
            </div>
